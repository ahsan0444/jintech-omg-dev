...
1. mcp__plugin_atlassian_atlassian__getAccessibleAtlassianResources → cloudId
2. mcp__plugin_atlassian_atlassian__getTransitionsForJiraIssue cloudId + issueIdOrKey=<TICKET_ID>
   → [{id, name}]
```
